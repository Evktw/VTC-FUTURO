...
// Returns the private 'App\Repository\ConduireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ConduireRepository.php';

return $this->privates['App\Repository\ConduireRepository'] = new \App\Repository\ConduireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

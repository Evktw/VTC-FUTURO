...
// Returns the private 'App\Repository\PermisExpirationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PermisExpirationRepository.php';

return $this->privates['App\Repository\PermisExpirationRepository'] = new \App\Repository\PermisExpirationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

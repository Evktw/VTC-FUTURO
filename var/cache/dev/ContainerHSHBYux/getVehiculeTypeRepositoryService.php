...
// Returns the private 'App\Repository\VehiculeTypeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\VehiculeTypeRepository.php';

return $this->privates['App\Repository\VehiculeTypeRepository'] = new \App\Repository\VehiculeTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\EmployesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EmployesRepository.php';

return $this->privates['App\Repository\EmployesRepository'] = new \App\Repository\EmployesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

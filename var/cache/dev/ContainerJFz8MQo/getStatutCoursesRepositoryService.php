...
// Returns the private 'App\Repository\StatutCoursesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\StatutCoursesRepository.php';

return $this->privates['App\Repository\StatutCoursesRepository'] = new \App\Repository\StatutCoursesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

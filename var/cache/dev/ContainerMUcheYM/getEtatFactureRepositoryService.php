...
// Returns the private 'App\Repository\EtatFactureRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EtatFactureRepository.php';

return $this->privates['App\Repository\EtatFactureRepository'] = new \App\Repository\EtatFactureRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

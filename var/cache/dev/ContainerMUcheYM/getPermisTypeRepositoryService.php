...
// Returns the private 'App\Repository\PermisTypeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PermisTypeRepository.php';

return $this->privates['App\Repository\PermisTypeRepository'] = new \App\Repository\PermisTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

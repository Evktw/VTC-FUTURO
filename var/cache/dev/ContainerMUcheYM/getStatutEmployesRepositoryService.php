...
// Returns the private 'App\Repository\StatutEmployesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\StatutEmployesRepository.php';

return $this->privates['App\Repository\StatutEmployesRepository'] = new \App\Repository\StatutEmployesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
